...
the same day, so it was **fifteen**; the stale counterfactual was closed
2026-09-12 by the Recompute button the owner asked for, so it is
**fourteen**. Re-audited 2026-09-11 end to end: all still
